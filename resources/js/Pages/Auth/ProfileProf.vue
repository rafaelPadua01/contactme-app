            ...
            <v-container class="py-8" fluid>
                ...
                <v-img
                        ...
                        <v-avatar color="grey" size="200" rounded="12">
                                <v-img
                                    :src="'storage/avatars/' + profile_img.image_name"
                                    alt="profile_image"
                                    cover
                                >
                ...
                <v-card-text>
                    ...
                    <v-row>
                        ...
                        <v-col class="d-flex" cols="8" sm="6">
                            <v-btn color="primary" @click="followUser">
                                <v-icon>mdi-plus</v-icon> Folow
                            </v-btn>
                            <v-btn color="primary" @click="dialogMessage">
                                <v-icon>mdi-send</v-icon> Message
                            </v-btn>
                            <v-btn color="primary" @click="others">
                        ...
                        <v-col class="d-flex" cols="4" sm="4">
                            ...
                            <div class="text-center">
                                <v-chip class="ma-2" color="pink-accent-4"
                                    v-for="especialidade in profile_prof.especialidades" :key="especialidade">
                        ...
                        <v-card>
                                ...
                                <v-toolbar-title>
                                    ...
                                    <template v-slot:activator="{props}">
                                        <v-btn icon v-bind="props">
                                            <v-icon>mdi-dots-vertical</v-icon>Close</v-btn>
                                    </template>
                                </v-toolbar-title>
                            ...
                            <v-card-text>
                                <v-form ref="form">
                                    ...
                                    preppend-icon="mdi-cloud-upload"
                                    variant="outlined"
                                    :show-size="1000"
